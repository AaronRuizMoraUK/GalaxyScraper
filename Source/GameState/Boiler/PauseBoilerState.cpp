...
std::string PauseBoilerState::name = "pause_boiler_state";

const D3DXVECTOR3 PauseBoilerState::onContinuePosition( -0.1f, 0.0f, 0.0f );
D3DXVECTOR3 PauseBoilerState::onBackToMenuPosition( -0.1f, -0.2f, 0.0f );

void PauseBoilerState::update( float deltaTime ) {
...
void PauseBoilerState::preRender( ) {
}

void PauseBoilerState::renderWorld3D( ) {
...
void PauseBoilerState::renderWorld2D( ) {
	Global::renderStateEnableAlphaBlending( );
	Global::renderStateEnableZTest( );
...
void PauseBoilerState::renderPostProcessed2D( ) {
}

void PauseBoilerState::renderGameUI( ) {
	Global::renderStateEnableAlphaBlending();
...
void PauseBoilerState::postRender( ) {
	// Print FPS
	Global::print(0,0, 0xffff0000, "Frames per second %0.2f", Game::fps);
	Global::print(0,10, 0xffff0000, "Pause Boiler Status");
}

void PauseBoilerState::renderFrame( ) {
	Global::renderTextureQuad.render( );
}

void PauseBoilerState::onLoad( ) {
	enter_pause = true;
	exit_pause = false;
	onContinue = true;
	arrow.setPosition( onContinuePosition );
...
void PauseBoilerState::onUnload( ) {
}

void PauseBoilerState::loadObjects( ) {
	// Arrow object
...
void PauseBoilerState::reloadShader( ) {
	arrow.reloadShader( );
