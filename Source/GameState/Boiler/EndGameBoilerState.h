#ifndef END_GAME_BOILER_STATE_H
#define END_GAME_BOILER_STATE_H
...
class EndGameBoilerState : public IGameState
{
protected:
...
public:
	...
	~EndGameBoilerState()
	{
		OutputDebugString("Destroying EndGameBoilerState...\n");
	};
