...
typedef struct CUSTOMVERTEX_TEXTURE_STRUCT
{
...
typedef struct CUSTOMVERTEX_NORMAL_TEXTURE_STRUCT
{
	float x, y, z;      // The local 3D position for the vertex
...
typedef struct CUSTOMVERTEX_NORMAL_TAN_TEXTURE_STRUCT
{
	float x, y, z;      // The local 3D position for the vertex
	float nx, ny, nz;	// The normal direction for the vertex
	float tx, ty, tz;	// The tangencial direction for the vertex
	float u1, v1;		// The texture coordenates for the vertex

	// Return the Vertex Declaration (FVF NOT USED)
	static VertexDeclaration getVertexDeclaration( ) { return CUSTOMVERTEX_NORMAL_TAN_TEXTURE_DECLARATION; };
} CUSTOMVERTEX_NORMAL_TAN_TEXTURE;
...
typedef struct CUSTOMVERTEX_COLOR_STRUCT
{
	float x, y, z;      // The local 3D position for the vertex
...
typedef struct CUSTOMVERTEX_TEXTURE_LIGHTMAP_STRUCT
{
	float x, y, z;      // The local 3D position for the vertex
...
typedef struct CUSTOMVERTEX_CAL3D_NORMAL_TAN_TEXTURE_STRUCT
{
	float x, y, z;				// The local 3D position for the vertex
	float nx, ny, nz;			// The normal direction for the vertex
	float tx, ty, tz;			// The tangencial direction for the vertex
...
} CUSTOMVERTEX_CAL3D_NORMAL_TAN_TEXTURE;
