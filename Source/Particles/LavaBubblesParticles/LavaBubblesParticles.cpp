#include "LavaBubblesParticles.h"
#include "Global/GlobalFunctions.h"
#include "Global/GlobalVariables.h"
#include "Object/CollisionableObject/AnimatedObject/AnimatedObject.h"

const std::string LavaBubblesParticles::type = "lava_bubbles";
const std::string LavaBubblesParticles::textureName = "particle_lava.dds";

LavaBubblesParticles::LavaBubblesParticles()
: ParticleEmitter(50)
, radius_a(0.3f)
{
}
...
void LavaBubblesParticles::update( float deltaTime )
{
...
void LavaBubblesParticles::createParticles()
{
	float offset = 2.0f * D3DX_PI / 8.0f;

	if (particles.size() + 8 > 17)
		return;
...
void LavaBubblesParticles::generate()
{
