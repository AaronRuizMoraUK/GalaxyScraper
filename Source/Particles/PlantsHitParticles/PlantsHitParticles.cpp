...
const std::string PlantsHitParticles::type = "plantsHit";
const std::string PlantsHitParticles::textureName = "particle_flare.dds";

PlantsHitParticles::PlantsHitParticles():IParticles()
{
}


void PlantsHitParticles::update( float deltaTime )
{
...
void PlantsHitParticles::generateSource()
{
	...
	particleContext.Size(pVec(0.2f, 0.2f, 0.2f));
