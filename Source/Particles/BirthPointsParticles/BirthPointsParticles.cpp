#include "BirthPointsParticles.h"
#include "Global/GlobalFunctions.h"
#include "Global/GlobalVariables.h"
#include "Object/CollisionableObject/AnimatedObject/AnimatedObject.h"

const std::string BirthPointsParticles::type = "birthPoint";
const std::string BirthPointsParticles::textureName = "particle_humillo2.dds";

BirthPointsParticles::BirthPointsParticles()
: ParticleEmitter(50)
, radius_a(0.3f)
{
}
...
void BirthPointsParticles::update( float deltaTime )
{
...
void BirthPointsParticles::createParticles()
{
...
void BirthPointsParticles::generate()
{
