...
const std::string ShootBoilerParticles::type = "shoot_boiler";
const std::string ShootBoilerParticles::textureName = "particle_smoke_boiler.dds";


ShootBoilerParticles::ShootBoilerParticles()
: ParticleEmitter(50)
, radius(0.0f)
{
	timeout.init(0.33f);
...
void ShootBoilerParticles::update( float deltaTime )
	{
...
void ShootBoilerParticles::generate()
{
	...
	for (int i = 0; i < 1; ++i)
	{
		...
		y = Global::obtainRandom(0.0f, 0.5f);
