#include "FirePlatformParticles.h"
...
const std::string FirePlatformParticles::type = "fire_platform";
const std::string FirePlatformParticles::textureName = "particle_boca.dds";


FirePlatformParticles::FirePlatformParticles()
: ParticleEmitter(50)
, radius(0.0f)
{
	timeout.init(0.33f);
...
void FirePlatformParticles::update( float deltaTime )
{
...
void FirePlatformParticles::generate()
{
