#include "KeyFramedROA.h"
#include "Global/GlobalFunctions.h"

std::string KeyFramedROA::controllerType = "keyframed_roa";

KeyFramedROA::KeyFramedROA( const RigidAnimationResource * pRigidAnimationResource )
...
void KeyFramedROA::update( AnimatedObject &object, float deltaTime )
{
...
void KeyFramedROA::restart( const D3DXVECTOR3 &initialPosition, const D3DXQUATERNION &initialRotation )
{
	// Sample start time
	currentTime = 0;
...
bool KeyFramedROA::isFinished() const { 
